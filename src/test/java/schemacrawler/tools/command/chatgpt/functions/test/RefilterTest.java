...
public class RefilterTest {
  ...
  public void refilterTest(final TestContext testContext) throws Exception {
    final DatabaseObjectListFunctionDefinition functionDefinition1 =
        new DatabaseObjectListFunctionDefinition();
    functionDefinition1.setDatabaseObjectType(SEQUENCES);
    databaseObjects(testContext.testMethodFullName() + ".sequences", functionDefinition1);

    final DatabaseObjectListFunctionDefinition functionDefinition2 =
        new DatabaseObjectListFunctionDefinition();
    functionDefinition2.setDatabaseObjectType(TABLES);
    databaseObjects(testContext.testMethodFullName() + ".tables", functionDefinition2);
  }

  private void databaseObjects(
      final String reference, final DatabaseObjectListFunctionDefinition functionDefinition)
      throws Exception {
