...
public final class DescribeRoutinesFunctionExecutor
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DescribeRoutinesFunctionExecutor.class.getCanonicalName());
  ...
  public JsonFunctionReturn call() throws Exception {
    ...
    LOGGER.log(Level.FINE, new StringFormat("Returned %d routines", catalog.getRoutines().size()));
