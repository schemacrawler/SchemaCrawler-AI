...
- Rename database server information function
- Return primary keys in table description by default
- Show next steps for each tool call
...
- Add annotations for tools so clients can run read-only tools without prompting
- Remove use of deprecated methods


<a name="v17.11.2-1"></a>
## Release 17.11.2-1 - 2026-05-31
...
<a name="v17.10.1-1"></a>
## Release 17.10.1-1 - 2026-04-12

- Follow SchemaCrawler release


<a name="v17.10.0-1"></a>
## Release 17.10.0-1 - 2026-04-03

- Follow SchemaCrawler release


<a name="v17.9.0-1"></a>
## Release 17.9.0-1 - 2026-03-28

- Follow SchemaCrawler release


<a name="v17.8.1-1"></a>
## Release 17.8.1-1 - 2026-03-19

- Follow SchemaCrawler release


<a name="v17.8.0-1"></a>
## Release 17.8.0-1 - 2026-03-14
